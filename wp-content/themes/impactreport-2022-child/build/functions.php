...
class Theme extends Timber\Site {
  ...
  use ThemeSearch;
	...
	public function __construct() {
		$this->theme_supports();
		add_action( 'enqueue_block_editor_assets', array($this,'theme_editor_override'), 100);
    add_action( 'wp_enqueue_scripts', array( $this, 'theme_enqueue_scripts' ), 11 );
    add_action( 'wp_enqueue_scripts', array( $this, 'theme_enqueue_styles' ), 11 );
		add_action( 'widgets_init', array( $this, 'theme_widgets_override' ), 100 );
  ...
  public function get_global_block($block_name) {
   ...
   public function activate_nav( $classes, $item ) {
	...
	public function theme_editor_override() {
  ...
  public function display_image_sizes($sizes) {
	...
	public function theme_widgets_override() {
