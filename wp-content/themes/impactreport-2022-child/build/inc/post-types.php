...
trait ThemePostTypes {
  ...
  function register_post_types() {
    ...
    foreach($post_types as $t=>$type) {
      ...
      $opts = [
        'labels' => [
          'name' => __( $type->plural, 'theme' ), /* This is the Title of the Group */
          'singular_name' => __( $type->single, 'theme' ), /* This is the individual type */
          'all_items' => __( 'All '.$type->plural, 'theme' ), /* the all items menu item */
          'add_new' => __( 'Add New', 'theme' ), /* The add new menu item */
          'add_new_item' => __( 'Add New '.$type->single, 'theme' ), /* Add New Display Title */
          'edit' => __( 'Edit', 'theme' ), /* Edit Dialog */
          'edit_item' => __( 'Edit '.$type->single, 'theme' ), /* Edit Display Title */
          'new_item' => __( 'New '.$type->single, 'theme' ), /* New Display Title */
          'view_item' => __( 'View '.$type->single, 'theme' ), /* View Display Title */
          'search_items' => __( 'Search '.$type->plural, 'theme' ), /* Search Custom Type Title */
          'not_found' =>  __( 'Nothing found in the Database.', 'theme' ), /* This displays if there are no entries yet */
          'not_found_in_trash' => __( 'Nothing found in Trash', 'theme' ), /* This displays if there is nothing in the trash */
          'parent_item_colon' => ''
        ], /* end of arrays */
        'description' => __( 'Theme '.$type->plural, 'theme' ), /* Custom Type Description */
        'public' => true,
